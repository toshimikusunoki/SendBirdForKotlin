...
object PreferenceUtils {
    ...
    val PREFERENCE_KEY_USER_ID = "userId"
    val PREFERENCE_KEY_NICKNAME = "nickname"
    val PREFERENCE_KEY_PROFILE_URL = "profileUrl"
    val PREFERENCE_KEY_CONNECTED = "connected"

    val PREFERENCE_KEY_NOTIFICATIONS = "notifications"
    val PREFERENCE_KEY_NOTIFICATIONS_SHOW_PREVIEWS = "notificationsShowPreviews"
    val PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB = "notificationsDoNotDisturb"
    val PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_FROM = "notificationsDoNotDisturbFrom"
    val PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_TO = "notificationsDoNotDisturbTo"
    val PREFERENCE_KEY_GROUP_CHANNEL_DISTINCT = "channelDistinct"
