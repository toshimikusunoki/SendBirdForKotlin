...
class GroupChatFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            mChannelUrl = arguments!!.getString(GroupChannelListFragment.EXTRA_GROUP_CHANNEL_URL)
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mRootLayout = rootView.findViewById<View>(R.id.layout_group_chat_root) as RelativeLayout
        mRecyclerView = rootView.findViewById<View>(R.id.recycler_group_chat) as RecyclerView

        mCurrentEventLayout = rootView.findViewById(R.id.layout_group_chat_current_event)
        mCurrentEventText = rootView.findViewById<View>(R.id.text_group_chat_current_event) as TextView

        mMessageEditText = rootView.findViewById<View>(R.id.edittext_group_chat_message) as EditText
        mMessageSendButton = rootView.findViewById<View>(R.id.button_group_chat_send) as Button
        mUploadFileButton = rootView.findViewById<View>(R.id.button_group_chat_upload) as ImageButton
    ...
    private fun sendUserMessageWithUrl(text: String, url: String) {
        object : WebUtils.UrlPreviewAsyncTask() {
            protected override fun onPostExecute(info: UrlPreviewInfo) {
